...
<img align="right" style="margin-top:10px;" alt="Text Encoding Library" src="https://cdn.rawgit.com/enonic/lib-text-encoding/master/lib-text-encoding.svg" width="200">
