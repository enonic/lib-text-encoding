...
|key
|string
|The secret key for HMAC-SHA1 encryption, as an hexadecimal string
|===
...
|key
|string
|The secret key for HMAC-SHA256 encryption, as an hexadecimal string
|===
...
|key
|string
|The secret key for HMAC-SHA512 encryption, as an hexadecimal string
|===
